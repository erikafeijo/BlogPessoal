...
public class Postagem {
	...
	@ManyToOne
	@JsonIgnoreProperties("postagem") //fala para o Json não virar um looping infinito, ignorando a propriedade de postagens
	private Tema tema; //Cria a chave estrangeira da tabela Tema
